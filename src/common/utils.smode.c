...
__attribute__((section(".jumpstart.text.smode"))) int32_t
smode_try_get_seed(void) {
  uint32_t seed;
  uint32_t i = 100;
...
__attribute__((section(".jumpstart.data.smode"))) uint64_t snext = 1;
